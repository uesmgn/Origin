...
class RemoteCommandManager: NSObject {
    ...
    /// The instance of `PlaybackManager` to use for responding to remote command events.
    ...
    func handleSeekForwardCommandEvent(event: MPSeekCommandEvent) -> MPRemoteCommandHandlerStatus {
        ...
        switch event.type {
        case .beginSeeking: PlaybackManager.beginFastForward()
        case .endSeeking: PlaybackManager.endRewindFastForward()
        }
        return .success
    }
    ...
    func handleSeekBackwardCommandEvent(event: MPSeekCommandEvent) -> MPRemoteCommandHandlerStatus {
        switch event.type {
        case .beginSeeking: PlaybackManager.beginRewind()
        case .endSeeking: PlaybackManager.endRewindFastForward()
        }
        return .success
    }
    ...
    func handleChangePlaybackPositionCommandEvent(event: MPChangePlaybackPositionCommandEvent) -> MPRemoteCommandHandlerStatus {
        PlaybackManager.seekTo(event.positionTime)
    ...
    func handleLikeCommandEvent(event: MPFeedbackCommandEvent) -> MPRemoteCommandHandlerStatus {
        ...
        if PlaybackManager.asset != nil {
            print("Did recieve likeCommand for \(PlaybackManager.asset.assetName)")
            return .success
        }
        else {
            return .noSuchContent
    ...
    func handleDislikeCommandEvent(event: MPFeedbackCommandEvent) -> MPRemoteCommandHandlerStatus {
        ...
        if PlaybackManager.asset != nil {
            print("Did recieve dislikeCommand for \(PlaybackManager.asset.assetName)")
            return .success
        }
        else {
            return .noSuchContent
    ...
    func handleBookmarkCommandEvent(event: MPFeedbackCommandEvent) -> MPRemoteCommandHandlerStatus {
        ...
        if PlaybackManager.asset != nil {
            print("Did recieve bookmarkCommand for \(PlaybackManager.asset.assetName)")
            return .success
        }
        else {
            return .noSuchContent
